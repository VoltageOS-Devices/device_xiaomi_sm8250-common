...
import org.lineageos.settings.kcal.KcalSettings;
...
public class GreenPreference extends CustomSeekBarPreference {
    ...
    public static boolean isSupported(Context context) {
        return FileUtils.isFileWritable(getFile(context));
    }
    ...
    public static void restore(Context context) {
        ...
        FileUtils.writeLine(getFile(context), storedValue);
    }
    ...
    private void saveValue(String newValue) {
        FileUtils.writeLine(getFile(getContext()), newValue);
